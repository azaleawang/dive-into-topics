...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/demo-data.proto",
}
...
type CommentServiceClient interface {
	GetAllComments(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*CommentList, error)
}
...
func (c *commentServiceClient) GetAllComments(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*CommentList, error) {
	out := new(CommentList)
	err := c.cc.Invoke(ctx, "/helloworld.CommentService/GetAllComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentServiceServer interface {
	GetAllComments(context.Context, *EmptyRequest) (*CommentList, error)
...
func (UnimplementedCommentServiceServer) GetAllComments(context.Context, *EmptyRequest) (*CommentList, error) {
...
func _CommentService_GetAllComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.CommentService/GetAllComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetAllComments(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "helloworld.CommentService",
